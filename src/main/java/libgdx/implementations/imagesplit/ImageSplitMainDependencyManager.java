...
public class ImageSplitMainDependencyManager extends MainDependencyManager<ImageSplitScreenManager, AbstractScreen, SkelGameLabel, Resource, SkelClassicGameIdEnum> {
    ...
    public ResourceService createResourceService() {
        return new ImageSplitGameResourceService();
    }
    ...
    @Override
    public ImageSplitScreenManager createScreenManager() {
        return new ImageSplitScreenManager();
    }
