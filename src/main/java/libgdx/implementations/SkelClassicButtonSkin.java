...
public enum SkelClassicButtonSkin implements ButtonSkin {
    ...
    KIDLEARN_MATH_ORD_LEVEL(KidLearnSpecificResource.btn_math_ord_level_up, KidLearnSpecificResource.btn_math_ord_level_down, KidLearnSpecificResource.btn_math_ord_level_up, KidLearnSpecificResource.btn_math_ord_level_up, null),
    KIDLEARN_MATH_SEQ_LEVEL(KidLearnSpecificResource.btn_math_seq_level_up, KidLearnSpecificResource.btn_math_seq_level_down, KidLearnSpecificResource.btn_math_seq_level_up, KidLearnSpecificResource.btn_math_seq_level_up, null),
    KIDLEARN_ENG_ANIMALS(KidLearnSpecificResource.btn_eng_animals_up, KidLearnSpecificResource.btn_eng_animals_down, KidLearnSpecificResource.btn_eng_animals_up, KidLearnSpecificResource.btn_eng_animals_up, null),
    KIDLEARN_ENG_FRUITS(KidLearnSpecificResource.btn_eng_fruits_up, KidLearnSpecificResource.btn_eng_fruits_down, KidLearnSpecificResource.btn_eng_fruits_up, KidLearnSpecificResource.btn_eng_fruits_up, null),
    KIDLEARN_ENG_VEGETABLES(KidLearnSpecificResource.btn_eng_vegetables_up, KidLearnSpecificResource.btn_eng_vegetables_down, KidLearnSpecificResource.btn_eng_vegetables_up, KidLearnSpecificResource.btn_eng_vegetables_up, null),
    KIDLEARN_ENG_NUMBERS(KidLearnSpecificResource.btn_eng_numbers_up, KidLearnSpecificResource.btn_eng_numbers_down, KidLearnSpecificResource.btn_eng_numbers_up, KidLearnSpecificResource.btn_eng_numbers_up, null),
    KIDLEARN_ENG_COLORS(KidLearnSpecificResource.btn_eng_colors_up, KidLearnSpecificResource.btn_eng_colors_down, KidLearnSpecificResource.btn_eng_colors_up, KidLearnSpecificResource.btn_eng_colors_up, null),
    KIDLEARN_ENG_SCHOOL(KidLearnSpecificResource.btn_eng_school_up, KidLearnSpecificResource.btn_eng_school_down, KidLearnSpecificResource.btn_eng_school_up, KidLearnSpecificResource.btn_eng_school_up, null),
    KIDLEARN_ENG_SHAPES(KidLearnSpecificResource.btn_eng_shapes_up, KidLearnSpecificResource.btn_eng_shapes_down, KidLearnSpecificResource.btn_eng_shapes_up, KidLearnSpecificResource.btn_eng_shapes_up, null),
    KIDLEARN_ENG_KITCHEN(KidLearnSpecificResource.btn_eng_kitchen_up, KidLearnSpecificResource.btn_eng_kitchen_down, KidLearnSpecificResource.btn_eng_kitchen_up, KidLearnSpecificResource.btn_eng_kitchen_up, null),
    KIDLEARN_ENG_SPORT(KidLearnSpecificResource.btn_eng_sport_up, KidLearnSpecificResource.btn_eng_sport_down, KidLearnSpecificResource.btn_eng_sport_up, KidLearnSpecificResource.btn_eng_sport_up, null),
