...
public enum ResourceWarsSpecificResource implements SpecificResource {
    ...
    amount_plus("buttons/btn0.png", Texture.class),
    amount_plus_clicked("buttons/btn0_clicked.png", Texture.class),
    amount_plus_disabled("buttons/btn_disabled.png", Texture.class),
